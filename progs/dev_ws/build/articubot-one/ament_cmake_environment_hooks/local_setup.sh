...
: ${AMENT_CURRENT_PREFIX:="/app/install/articubot-one"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/articubot-one/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/articubot-one/environment/path.sh"
